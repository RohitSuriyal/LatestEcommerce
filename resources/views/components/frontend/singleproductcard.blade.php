...
<div class="row mx-0 p-3 ">
    ...
    <div class="col-md-4 h-100">
        ...
        <div class="my-5 d-flex gap-3 my-2">
            <x-frontend.addtocartbutton />
           <x-frontend.buynowbutton id="{{ $product->id }}" />
        </div>
    </div>

    <div style="height:493px" class="col-md-6 bg-white ">
        ...
        <h5 style="font-weight:bold" class="mt-2">Price: ₹{{ $product->price ?? '' }}</h5>
